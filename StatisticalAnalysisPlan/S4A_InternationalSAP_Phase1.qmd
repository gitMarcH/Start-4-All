...
dfHist<-data.frame(
  Version=c("1.4","1.3","1.2","1.1","1.0"),
  Date=c("2025-05-27","2025-05-27","2024-05-27","2025-05-26","2025-05-25"),
  Author=c("Marc Henrion","Marc Henrion","Marc Henrion","Marc Henrion","Marc Henrion"),
  Edits=c("Slight changes to protocol summary text; revised language for PCF/ICF (facility-based) ACF (community-based) and pooled (aggregate) analysis; addition of mock-ups for community-based CXR-CAD entry to study","All analyses tested; mock-up output for PCF/ICF setting included","Clarified agorithms with pooled Xpert Ultra testing and updated JAGS files correspondingly","Descriptive analysis mock-ups added; full JAGS model files added; details of MCMC run parameters; added JAGS version number; slightly revised secondary analyses","First full version of the SAP (while development versions 0.1 to 0.14 exist, no version history record was kept prior to v1.0)")
)

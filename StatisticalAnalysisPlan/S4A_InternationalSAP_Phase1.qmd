...
This Statistical Analysis Plan (SAP) v1.1 is based on the Start 4 All International Protocol v1.6, dated 22 May 2023.
...
dfHist<-data.frame(
  Version=c("1.1","1.0"),
  Date=c("2025-05-25","2025-05-26"),
  Author=c("Marc Henrion","Marc Henrion"),
  Edits=c("Mock-ups added; full JAGS model files added; details of MCMC run parameters; added JAGS version number; slightly revised secondary analyses","First full version of the SAP (while development versions 0.1 to 0.14 exist, no version history record was kept prior to v1.0)")
)

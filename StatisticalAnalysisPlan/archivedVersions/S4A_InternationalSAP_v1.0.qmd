...
This version of the SAP does not include mock-ups as they need to be re-done completely given the change in algorithms being evaluated. While the analysis plan itself is complete, mock-ups will only be included in the next version.
